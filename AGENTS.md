...
Flagdle is a client-only flag guessing game built with React 19, TypeScript, Vite, Zustand, and i18next. Country data and flag SVGs are checked into this repository; the game does not need a live country API.
